...
public class MiniGameEndScoreUIManager : MonoBehaviour
{
    ...
    [SerializeField]
    private Text score_text, rank_text, money_text, score_title, rank_title, money_title, score_msg, replay_text;
    ...
    private readonly Color color_transparent = new(0, 0, 0, 0);
    ...
    public void ShowScore(int score)
    {
        ...
        DOVirtual.Int(0, score, 0.5f, score_tween => { score_text.text = score_tween + "점"; }).SetDelay(0.15f);
        ;
        ...
        var adCount = PlayerPrefs.GetInt("Minigame_adCount", 0);
        ...
        else
        {
            ...
            DOVirtual.Float(1f, 0f, 6f, float_tween => { replayBtnTimer.value = float_tween; })
