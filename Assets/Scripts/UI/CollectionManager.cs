...
public class CollectionManager : MonoBehaviour
{
    ...
    [SerializeField] private Sprite[] imgs = new Sprite[0];
    [SerializeField] private Sprite[] imgsHighres = new Sprite[0];
    [SerializeField] private AchievementManager achievement;
    [SerializeField] private AudioController myAydio;
    ...
    {
        if (!PlayerPrefs.HasKey("card_" + i)) PlayerPrefs.SetInt("card_" + i, 0);
    ...
    private IEnumerator OpenCardRoutine(int i, bool isnew = false)
    {
        print("OPEN CARD : " + i);
    ...
    public void OpenNew()
    {
        ...
        if (isnew) myAydio.PlaySoundFx(0);
    ...
    {
        var rnd = Random.Range(0, myCard.Count);
    ...
    public void HideCard()
    {
        ...
        if (isnew) achievement.ReceiveRank();
    }
