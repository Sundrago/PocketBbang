...
{
    [FormerlySerializedAs("achievement")] [SerializeField]
    private AchievementManager achievementManager;

    [SerializeField] private GameObject rankup_ui,
        text01_ui,
        text02_ui,
        closeBtn_ui,
        rankSlider,
    ...
    [SerializeField] private GameObject rankingChart, rankingChartText, showChartBtn, closeChartBtn;
    [SerializeField] private GameObject small_rank_ui;
    ...
    private int currnetRank;
    private int currnetScore;
    private bool initial;
    private bool started;

#if UNITY_IPHONE
    private const int totalCount = 43470;
#elif UNITY_ANDROID
    ...
    public void Start()
    {
        ...
        if (PlayerPrefs.GetInt("oldScore") == totalCount)
        {
            ...
            initial = true;
            achievementManager.UpdateDataAndReceiveRank();
        }
        else
        {
    ...
    public void CheckForUpdate(int score)
    {
        ...
        var oldScore = PlayerPrefs.GetInt("oldScore");
    ...
    {
        var rank = (1 - _score / (float)totalCount) * 100f;
        State myState;
    ...
    public void AnimFinished()
    {
        ...
        text01_ui.GetComponent<Text>().text =
            "#수집한 스티커 " + PlayerPrefs.GetInt("myTotalCards") + "/" + PlayerPrefs.GetInt("TotalCards");
    ...
    {
        sliderText_ui.GetComponent<Text>().text =
            "상위 " + Mathf.Round(1000 - rankSlider.GetComponent<Slider>().value * 1000) / 10f + "%";
    }
    ...
    private IEnumerator RecordFrame()
    {
        ...
        var myText = "#" + sliderText_ui.GetComponent<Text>().text + "\n" + text01_ui.GetComponent<Text>().text + "\n";
